...
flowchart TD
    Start
    Start --> DownloadMF[Download Masterfile]
    DownloadMF --> EnsureDetails{All Details Present?}
    EnsureDetails -- Yes --> Step2[Proceed to Template]
    EnsureDetails -- No --> UpdateMF[Update Masterfile]
    UpdateMF --> DownloadMF
            </div>
        </div>
        ...
        <div class="step">
            ...
            <div class="mermaid">
flowchart TD
    MF[Masterfile] --> Template[Template File]
    ASC[ASC VAR] --> Template
    VW[Variation Wizard (VW VAR)] --> Template
            </div>
            <figure>
        ...
        <div class="step">
            ...
            <div class="mermaid">
flowchart TD
    CLR[Download CLR] --> AddCLR[Add CLR to Template]
    ALR[Download ALR] --> AddALR[Add ALR to Template]
...
flowchart TD
    ...
    CompareCLR -- Parent SKU Match --> TrueA[TRUE: Part of Correct Variation]
    CompareCLR -- No Match or NA --> FalseA[FALSE: Not Part of Any or Correct Variation]
            </div>
        </div>
        ...
        <div class="step">
            ...
            <div class="mermaid">
flowchart TD
    VW[Variation Wizard Frontend] --> DataExtract[Extract SKUs/ASINs/etc.]
    DataExtract --> AddToSheet[Add to VW and VW VAR Sheets]
            </div>
        </div>
...
flowchart TD
    ...
    VWCompare -- Parent SKU Match --> TrueB[TRUE: Correct Variation]
    VWCompare -- Parent SKU Missing --> ParentASINChk[Check Parent ASIN]
    ParentASINChk -- Match --> Comment1B[Comment: Parent SKU not found, but part of our variation]
    ParentASINChk -- No Match --> Comment2B[Comment: Not a part of our variation]
    VWCompare -- SKU Not Found --> FalseB[FALSE: Not part of any variation]
    VWCompare -- Variation Theme Match --> TrueC[TRUE]
    VWCompare -- Variation Theme Mismatch --> FalseC[FALSE]
            </div>
        </div>
        ...
        <div class="step">
            ...
            <div class="mermaid">
flowchart TD
    Review[Review Audit] --> Comments[Add Comments & Markings] --> Submission[Prepare & Submit Final Template]
            </div>
        </div>
    </section>
...
flowchart TD
    ...
    DownloadWM --> EnsureWM{All Details Present?}
    EnsureWM -- Yes --> Step2WM[Proceed to Template]
    EnsureWM -- No --> UpdateWM[Update Masterfile]
    UpdateWM --> DownloadWM
            </div>
        </div>
...
flowchart TD
    ...
    CompareIR -- No Match or NA --> FalseWM[FALSE: Not Correct or Any Variation]
            </div>
        </div>
        ...
        <div class="step">
            ...
            <div class="mermaid">
flowchart TD
    ReviewWM[Review Audit (Walmart)] --> CommentsWM[Add Comments/Markings] --> SubmitWM[Prepare & Submit Final Template]
            </div>
        </div>
    </section>
</main>
